...
{
    internal static class Program43
    {
        [STAThread]
        private static void Main(string[] args)
        {
            ...
            if (gameRoot == null)
            {
                using (var picker = new FolderBrowserDialog())
                {
                    ...
                    {
                        MessageBox.Show("Папка Bannerlord не найдена.", "KaiTOR Load Monitor 0.4.3", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        return;
                    }
            ...
            Application.Run(new LiveLoadMonitorForm(gameRoot));
        }
