...
2. Открыть Королевство -> Дипломатия, выбрать другую державу и нажать «Дипломатия и династия». Оставить экран открытым не менее 60 секунд, затем закрыть/открыть его 10 раз.
3. В разделе «Дипломатия и династия»: выбрать державу, сменить длительность пакта, проверить предложение NAP и разрыв NAP при допустимых игровых условиях. Каждое нажатие должно либо создать council decision, либо показать явную причину отказа.
...
- native Kingdom Diplomacy -> «Дипломатия и династия»;
...
- [ ] Королевство -> Дипломатия -> выбранная держава показывает «Дипломатия и династия».
- [ ] Кнопка «Дипломатия и династия» открывает сводку договоров, дома и державы; выбранная держава уже подставлена.
