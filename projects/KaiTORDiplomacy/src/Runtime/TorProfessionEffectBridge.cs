        ...
        try
        {
            ...
            switch (professionId)
            {
                ...
                case "option_3_mousillon_necromancer":
                    ...
                    // TOR AddCareer(Necromancer) then runs InitialCareerSetup:
                    // human pantheon -100 and another +25 Nagash. Apply only the
                    // personal faith effects; never touch MainHero/world state.
