    ...
    internal class CoopMod : NoHarmonyLoader
    {
        ...
        public override void NoHarmonyLoad()
        {
            ...
            CoopCampaign = new InitialStateOption(
                    "CoOp Campaign",
                    new TextObject(isServer ? "{=kaitor_menu_host}Host KaiTOR Co-op" : "{=kaitor_menu_join}Join KaiTOR Co-op"),
                    9990,
                    () =>
                    {
            ...
            CoopCampaign = new InitialStateOption(
                    "CoOp Campaign",
                    new TextObject("{=kaitor_menu_host}Host KaiTOR Co-op"),
                    9990,
                    () =>
                    {
            ...
            JoinCoopGame =
                new InitialStateOption(
                  "Join Coop Game",
                  new TextObject("{=kaitor_menu_join}Join KaiTOR Co-op"),
                  9991,
                  JoinWindow,
              () => { return (false, new TextObject("")); }
            );
