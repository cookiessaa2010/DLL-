...
public class PlayerNameplatesSection : CoopOptionsSectionVM
{
    ...
    public PlayerNameplatesSection(PlayerNameplatesDisplayMode displayMode, IMessageBroker messageBroker)
    {
        ...
        DisplayModeSelector = new SelectorVM<SelectorItemVM>(
            new[]
            {
                GameInterface.Services.UI.KaiTORUiText.Get("kaitor_always", "Always"),
                GameInterface.Services.UI.KaiTORUiText.Get("kaitor_hold_indicators", "Hold Indicators"),
                GameInterface.Services.UI.KaiTORUiText.Get("kaitor_never", "Never"),
            },
            (int)displayMode,
            null);
    }
    ...
    public string TitleText => GameInterface.Services.UI.KaiTORUiText.Get("kaitor_player_nameplates", "Player Nameplates");
    public string DescriptionText => GameInterface.Services.UI.KaiTORUiText.Get("kaitor_player_nameplates_desc", "Show names above allied players in co-op missions.");
    public string DisplayModeText => GameInterface.Services.UI.KaiTORUiText.Get("kaitor_display_mode", "Display Mode");
