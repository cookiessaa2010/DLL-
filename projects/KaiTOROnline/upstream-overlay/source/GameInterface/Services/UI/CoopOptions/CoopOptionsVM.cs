...
public class CoopOptionsVM : ViewModel
{
    ...
    public string MovieTextHeader => KaiTORUiText.Get("kaitor_options_header", "KaiTOR Co-op Options");
    public string ApplyButtonText => KaiTORUiText.Get("kaitor_apply", "Apply");
    ...
    public void ActionApply()
    {
        ...
        string message = KaiTORUiText.Get("kaitor_options_updated", "KaiTOR Co-op options updated.");
        ...
        {
            message = KaiTORUiText.Get("kaitor_options_update_failed", "KaiTOR Co-op options could not be updated.");
        }
