...
public class MapTimeSection : CoopOptionsSectionVM
{
    ...
    public string TitleText => GameInterface.Services.UI.KaiTORUiText.Get("kaitor_map_time", "Map Time");
    public string DescriptionText => GameInterface.Services.UI.KaiTORUiText.Get("kaitor_map_time_desc", "Configure the map time display shown while inside missions.");
    public string ShowMapTimeInMissionsText => GameInterface.Services.UI.KaiTORUiText.Get("kaitor_show_map_time", "Show Map Time in Missions");
