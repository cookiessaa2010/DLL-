...
public class NetworkSection : CoopOptionsSectionVM
{
    ...
    public string TitleText => GameInterface.Services.UI.KaiTORUiText.Get("kaitor_movement_bandwidth", NetworkOptionsTabProvider.SectionTitleText);
    public string DescriptionText => GameInterface.Services.UI.KaiTORUiText.Get("kaitor_movement_bandwidth_desc", NetworkOptionsTabProvider.SectionDescriptionText);
    public string UploadText => GameInterface.Services.UI.KaiTORUiText.Get("kaitor_upload_limit", NetworkOptionsTabProvider.UploadText);
    public string DownloadText => GameInterface.Services.UI.KaiTORUiText.Get("kaitor_download_limit", NetworkOptionsTabProvider.DownloadText);
