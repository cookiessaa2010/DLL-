	...
	class SelectedGameVM : SavedGameVM
	{
		...
		public new void ExecuteSaveLoad()
		{
            ...
            var visibilityOptions = new List<InquiryElement>
            {
                new InquiryElement(
                    ...
                    global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_public", "Public"),
                    null,
                    true,
                    global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_public_hint", "Listed in Server Discovery for everyone.")),
                new InquiryElement(
                    ServerVisibility.FriendsOnly,
                    global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_friends_only", "Friends Only"),
                    null,
                    true,
                    global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_friends_only_hint", "Listed in Server Discovery for your Steam friends only.")),
                new InquiryElement(
                    ServerVisibility.None,
                    global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_hidden", "Hidden"),
                    null,
                    true,
                    global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_hidden_hint", "Hidden from Server Discovery; Steam joins, direct connections, and owner loopback still work.")),
            };

            MBInformationManager.ShowMultiSelectionInquiry(new MultiSelectionInquiryData(
                global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_server_visibility", "Server visibility"),
                global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_server_visibility_desc", "Choose who can discover this server."),
                visibilityOptions,
                isExitShown: true,
                minSelectableOptionCount: 1,
                maxSelectableOptionCount: 1,
                global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_continue", "Continue"),
        ...
        private void ShowPasswordInquiry(ServerVisibility visibility)
        {
            InformationManager.ShowTextInquiry(new TextInquiryData(
                ...
                global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_server_password_desc", "Set an optional password for this server. Leave it blank to allow anyone to join."),
                true,
                true,
                global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_host", "Host"),
                global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_cancel", "Cancel"),
        ...
        private static Tuple<bool, string> ValidatePassword(string password)
        {
            ...
            return Tuple.Create(valid, valid
                ? string.Empty
                : global::GameInterface.Services.UI.KaiTORUiText.Format("kaitor_password_max_error", "Password cannot exceed {MAX_LENGTH} characters.", ("MAX_LENGTH", ConnectionPassword.MaxLength)));
        }
