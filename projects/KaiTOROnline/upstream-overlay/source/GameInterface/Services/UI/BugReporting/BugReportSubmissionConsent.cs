...
public class BugReportSubmissionConsent : IBugReportSubmissionConsent
{
    ...
    public InquiryData CreateInquiry(Action allow, Action decline)
    {
        ...
        return new InquiryData(
            global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_bug_share_title", PromptTitle),
            global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_bug_share_prompt", PromptText),
            true,
            true,
            global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_allow", "Allow"),
