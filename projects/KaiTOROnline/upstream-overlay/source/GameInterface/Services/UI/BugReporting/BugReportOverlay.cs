...
internal sealed class BugReportOverlay : GlobalLayer, IBugReportOverlay
{
    ...
    private void CompletePendingSubmission(string summary, string description)
    {
        ...
        {
            dataSource.SetSubmissionError(global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_bug_send_failed", "The bug report could not be sent."));
            FocusForm();
        }
    }
