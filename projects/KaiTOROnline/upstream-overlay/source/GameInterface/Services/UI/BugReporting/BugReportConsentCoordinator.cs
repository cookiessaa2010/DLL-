...
public class BugReportConsentCoordinator
{
    ...
    public void ShowPrompt(Action<InquiryData> showInquiry)
    {
        ...
        showInquiry(new InquiryData(
            global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_bug_logs_title", PromptTitle),
            global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_bug_logs_prompt", PromptText),
            true,
            true,
