...
public class CrashReportingConsentCoordinator
{
    ...
    public void TryShowPrompt(bool canShow, Action<InquiryData> showInquiry)
    {
        ...
        showInquiry(new InquiryData(
            global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_crash_reports_title", PromptTitle),
            global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_crash_reports_prompt", PromptText),
            true,
            true,
            global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_enable", "Enable"),
            global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_no_thanks", "No thanks"),
            () => RecordDecision(true),
