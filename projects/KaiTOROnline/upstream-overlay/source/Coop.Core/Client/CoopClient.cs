...
public class CoopClient : CoopNetworkBase, ICoopClient
{
    ...
    public override void OnPeerConnected(NetPeer peer)
    {
        if(isConnected == false)
        {
            ...
            messageBroker.Publish(this, new SendInformationMessage(
                global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_connected_wait", "Connected! Please wait for transfer.")));
    ...
    public override void OnPeerDisconnected(NetPeer peer, DisconnectInfo disconnectInfo)
    {
        if (!isConnected && disconnectInfo.Reason == DisconnectReason.ConnectionRejected)
        {
            ...
            string message = rejectCode == ConnectionRejectCode.IncorrectPassword
                ? global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_incorrect_password", "The server password is incorrect.")
                : global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_server_rejected", "The server rejected the connection.");
    ...
    {
        messageBroker.Publish(this, new SendInformationMessage(
            global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_connecting", "Connecting...")));
    ...
    public override void Update(TimeSpan frameTime)
    {
        ...
        if (reconnectPending && DateTime.UtcNow >= reconnectAfter)
        {
            ...
            messageBroker.Publish(this, new SendInformationMessage(
                global::GameInterface.Services.UI.KaiTORUiText.Get("kaitor_retrying_connection", "Retrying connection to server...")));
