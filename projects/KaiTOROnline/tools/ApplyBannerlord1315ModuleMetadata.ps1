...
if ($props.Contains('<CoopVersion>0.1.5</CoopVersion>')) {
    $props = $props.Replace('<CoopVersion>0.1.5</CoopVersion>', '<CoopVersion>1.3.15.12</CoopVersion>')
}
elseif (-not $props.Contains('<CoopVersion>1.3.15.12</CoopVersion>')) {
